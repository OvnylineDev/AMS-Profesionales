<?php
     ...
     */
     ...
     class RtfControlWord extends RtfElement{
          ...
          {
               $cadena = "";
               $cadena .= "<div style='color:green'>";
               $cadena .= $this->Indent($level);
               $cadena .= "WORD {$this->word} ({$this->parameter})";
               $cadena .= "</div>";
               return $cadena;
          }
     }
     ...
     class RtfControlSymbol extends RtfElement
     {
          ...
          public function dump($level){
               ...
               $cadena .=  $this->Indent($level);
               $cadena .=  "SYMBOL {$this->symbol} ({$this->parameter})";
               $cadena .=  "</div>";
               return $cadena;
          }
     }
